                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                            <input type="radio" name="payment" value="UPI" > UPI<br>
                             <img src="images/Bkash.png" alt="" style="height:100px; width:200px;">
                             <br><br><br>
                             <input type="radio" name="payment" value="Netbanking" >  Netbanking<br>
                             <img src="images/Netbank.png" alt="" style="height:100px; width:200px;">
                             <br><br><br>
                             <input type="radio" name="payment" value="Card" >  Credit/Debit Card<br>
                             <img src="images/card.png" alt="" style="height:100px; width:200px;">
                             <br><br><br>
                             <input type="radio" name="payment" value="Cash_on_delivery"> Cash on delivery<br>
                             <img src="images/cod.png" alt="" style="height:100px; width:200px;">
                        </div>
