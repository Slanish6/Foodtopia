...
<?php
  ...
  if(isset($_SESSION['valid'])!=true){
    ...
    echo 'alert("Please login or signup first.");'; 
			...
			<div class="panel panel-info">
				...
				<div class="panel-body">
					...
					<div class="row">
						...
						<div class="col-xs-4">
							<h4 class="product-name"><strong style="font-family:Axiforma; font-size:11px; padding-left: 105px; position:absolute; left:63px;"><?php echo "$row[item]"; ?></strong></h4>
						</div>
						<div class="col-xs-6">
