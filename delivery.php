			...
			<div class="panel panel-info">
				...
				<div class="panel-body">
					<div class="row">
						...
						<div class="col-xs-4">
							<h4 class="product-name"><strong>Order #555</strong></h4><h4><small>Restaurant: KFC</small><br><small>Shipping Address: Bashundhara<br> Road#5 Block#C Flat #2A
								<br>Phone no. 0175XXXXXXXX</small><br></h4>
						</div>
						<div class="col-xs-6">
							<div class="col-xs-6 text-right">
								<h6><strong>Tk 50.00 <span class="text-muted"></span></strong></h6>
							</div>
					...
					<div class="row">
						...
						<div class="col-xs-4">
							<h4 class="product-name"><strong>Order #556</strong></h4><h4><small>Restaurant: KFC</small><br><small>Shipping Address: Bashundhara<br> Road#5 Block#C Flat #2A
								<br>Phone no. 0175XXXXXXXX</small><br></h4>
						</div>
						<div class="col-xs-6">
							<div class="col-xs-6 text-right">
				...
				<div class="panel-footer">
					<div class="row text-center">
						<div class="col-xs-9">
							<h4 class="text-right">Total <strong>TK 100.00</strong></h4>
						</div>
						<div class="col-xs-3">
